       ...
       // If we are trying to find distance from vertex to itself, make this distance 0
        ...
        for (int i = 1; i < numOfVertices; i++)
        {
                     ...
                     index++)
            {
                ...
                {
                    nearestVertex = index;
                    shortestDistance = shortestPath[index];
                }
            }
            ...
            for (int index = 0;
                     ...
                     index++)
            {
                int edgeDistance = A[nearestVertex][index];
                 
                if (edgeDistance > 0
                    && ((shortestDistance + edgeDistance) <
                        shortestPath[index]))
                {
                    shortestPathArray[index] = nearestVertex;
                    shortestPath[index] = shortestDistance +
                                                       edgeDistance;
                }
            }
        }
                                      ...
                                      int[] shortestPathArray)
    {
        ...
        for (int index = 0; index < numOfVertices; index++)
        {
            if (index != start)
            {
                ...
                printPath(index, shortestPathArray);
            }
        }
    }
