...
class assignment3 
{
    public static void main(String args[]) 
    {
        try 
        {
            ...
            PageRank(matrix, 0.79, ); // Make a call to the PagRank method with givenm 
    ...
    public static void PageRank(int[][] A, float dampingFactor,  float convergenceCriteria) 
    {
        for (int[] x : A)
        {
            for (int y : x)
        ...
        System.out.println(String.valueOf(dampingFactor) + " " + String.valueOf(convergenceCriteria));   
    }
}