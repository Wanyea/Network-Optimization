...
class assignment3 
{
        ...
        try 
        {
            ...
            while (!hasConverged) 
            {
                for (int i = 0; i < 100; i++) 
                {
                    ...
                    // If the below the convergence criteria, stop program. 
                ...
                writer.write("Number of iterations: " + String.valueOf(22) + "\n");
    ...
    // Calculate values that will be added to each page accordingly.
