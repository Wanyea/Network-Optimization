            ...
            if(dataFileInput.hasNext()) 
            {
                ...
                if (whichNode == 0) 
                {
                    ...
                    if (newestFromNode != fromNode) 
                    {
                        ...
                        AmazonGraph.addVertex(newestFromNode);
                    }
                    ...
                    {
                        newestToNode = toNode;
                        AmazonGraph.addVertex(newestToNode);
                    }

                    System.out.println(AmazonGraph.vertices.get(fromNode));
                    System.out.println(AmazonGraph.vertices.get(toNode));
