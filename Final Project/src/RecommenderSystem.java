...
public class RecommenderSystem 
{
  ...
  public static void main(String[] args) 
  {
    ...
    try 
    {
        ...
        int itemChosen = sc.nextInt();

        // Output text file with soltuion. 
        writer.write("Your input item: " + String.valueOf(itemChosen));
        writer.write("Your top five recommended items: ");
        writer.write(String.valueOf(makePrediction(itemChosen)).getData() + ", ");
...
public Vertex makePredictions(int itemChosen) {
